# 2. Реализовать программу работы с органическими клетками, состоящими из ячеек. Необходимо создать класс Клетка. В его
...
class Cell:
    ...
    def __sub__(self, other):
        ...
        return f'Вычитание клеток. Клетка состоит из {sub} клеточек' if sub > 0 else 'Клетка исчезла'
